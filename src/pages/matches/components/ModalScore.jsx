        ...
        <Modal className="text-dark" show={modalShow} onHide={handleClose} backdrop="static" keyboard={false}>
            <Modal.Header closeButton>
                ...
                <Form.Group>
                        ...
                        <FormControl {...formik.getFieldProps('local')} type="number" id="local" name="local" placeholder='Marcador equipo local'></FormControl>
                        </Form.Group>
                        <Form.Label htmlFor='away'>{match?.away?.name} :</Form.Label>
                        <FormControl {...formik.getFieldProps('away')} type="number" id="away" name="away" placeholder='Marcador equipo visitante'></FormControl>
            </Modal.Body>
            <Modal.Footer>
                <Button variant="dark" onClick={() => handleClose()}>Cerrar</Button>
                <Button variant="warning" type="submit">Colocar marcador</Button>
            </Modal.Footer>
        </Form>
      </Modal>
